...
// if there was one. This uses the crypto/rand package so it is safe
// to use with things like remember tokens.
...
// String will generate a byte slice of size nBytes and then return a 
